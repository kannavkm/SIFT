...
GLOBAL(int) write_JPEG_file (const char * filename, int quality)
{
...
GLOBAL(int) read_JPEG_file (const char * filename)
{
  ...
  img.buffer = (JSAMPLE*) malloc(sizeof(unsigned char) * row_stride * img.height);
  ...
  while (cinfo.output_scanline < cinfo.output_height) {
    ...
    unsigned char* ptr = &img.buffer[i * row_stride];
